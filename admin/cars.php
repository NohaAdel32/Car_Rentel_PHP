        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              ...
              <font color="green"><?php echo $del; ?></font>
                <h3>Manage Cars</h3>
              </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td><a href="delete.php?id=<?php echo $id?>" onclick="return confirm('Are you sure you want to delete?')"><img src="./images/delete.png" alt="Delete"></td>
                        </tr>
                        <?php
                             }
                          ?>
